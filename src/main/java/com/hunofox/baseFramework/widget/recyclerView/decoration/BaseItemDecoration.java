...
public abstract class BaseItemDecoration extends RecyclerView.ItemDecoration{
    ...
    protected BaseItemDecoration(Builder builder) {
        ...
        footerCount = builder.footerCount;
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        childCount = showFooterDivider?childCount:childCount-footerCount;
    ...
    public static class Builder<T extends Builder> {
        ...
        public T showLastDivider(boolean show) {
            mShowLastDivider = show;
            return (T) this;
        }

        public T showFooterDivider(boolean show) {
            showFooterDivider = show;
            return (T) this;
        }

        public T footerCount(int count) {
            footerCount = count>=0?count:0;
            return (T) this;
        }
