...
import com.hunofox.baseFramework.widget.wheelView.adapters.WheelViewAdapter;
...
public class WheelView extends View
{
    ...
    public void setCurrentItem(int index, boolean animated)
    {
        ...
        //更新适配器中当前选中项序号
        viewAdapter.updateCurrentItem(index);
     ...
     *
     * @param canvas the canvas for drawing 阴影
     */
    ...
    private void drawCenterRect(Canvas canvas)
    {
        ...
        paint.setColor(Color.parseColor("#88d1d1d1"));
        // 设置线宽
        ...
        paint.setStyle(Paint.Style.FILL);//矩形框
        paint.setColor(Color.parseColor("#88f4f4f4"));
        canvas.drawRect(new RectF(0, center - offset, getWidth(), center +
                offset), paint);
    }
